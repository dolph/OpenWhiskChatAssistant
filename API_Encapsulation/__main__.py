...
from watson_developer_cloud.natural_language_understanding_v1 import \
    Features,CategoriesOptions,ConceptsOptions,EmotionOptions, EntitiesOptions, \
    KeywordsOptions,MetadataOptions,RelationsOptions,SentimentOptions
...
#print main({"text":"The Chinese Comac C919 airliner takes place.","type":"Emotion"})
