...
class TranslationModel(object):
    ...
    :attr str owner: (optional) Returns the IBM Cloud ID of the instance that created the model, or an empty string if it is a model that is trained by IBM.
    ...
    def __init__(self,
        ...
        :param str owner: (optional) Returns the IBM Cloud ID of the instance that created the model, or an empty string if it is a model that is trained by IBM.
